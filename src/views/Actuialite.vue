<template>
    <div class=" container">
        <div class="flex  justify-center items-center pt-9 gap-2 font-display" >
           <h1 class="text-3xl text-text  "> SUIVEZ</h1> <h1 class="text-3xl">NOTRE ACTUALITE</h1> 
        </div>

        <!-- component -->
<!-- Display Container (not part of component) START -->
  <div class="m-4 mx-auto p-10   ">
    
    <!-- Carousel Body -->
    <div class="relative rounded-lg block md:flex items-center bg-orange-100 shadow-xl" style="min-height: 19rem;">
      <div class="relative w-full md:w-2/5 h-full overflow-hidden rounded-t-lg md:rounded-t-none md:rounded-l-lg" style="min-height: 19rem;">
        <img class="absolute inset-0 w-full h-full object-cover object-center" src="../../public/img/pexels-cottonbro-studio-4327024.jpg" alt="">
