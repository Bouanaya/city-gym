<template>
  <div class="container">
    <div class="flex justify-center items-center pt-9 gap-2 font-display">
      <h1 class="text-3xl text-text">SUIVEZ</h1>
      <h1 class="text-3xl">NOTRE ACTUALITE</h1>
    </div>
    ...
    <div class="m-4 mx-auto p-10">
      <!-- Carousel Body -->
      <div
        class="relative rounded-lg block md:flex items-center bg-orange-100 shadow-xl"
      ...
      >
        ...
        >
          <img
            ...
            src="../../public/img/pexels-cottonbro-studio-4327024.jpg"
            alt=""
          />
        ...
        <div
          class="w-full md:w-3/5 h-full flex items-center bg-orange-100 rounded-lg"
        >
